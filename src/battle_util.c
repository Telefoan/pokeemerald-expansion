...
const struct TypePower gNaturalGiftTable[] =
{
    ...
    [ITEM_TO_BERRY(ITEM_HIPUP_BERRY)] = {TYPE_BUG, 90},
    [ITEM_TO_BERRY(ITEM_PIPUP_BERRY)] = {TYPE_ROCK, 90},
    [ITEM_TO_BERRY(ITEM_PROTIE_BERRY)] = {TYPE_GHOST, 90},
    [ITEM_TO_BERRY(ITEM_EYEROH_BERRY)] = {TYPE_DRAGON, 90},
    [ITEM_TO_BERRY(ITEM_CALCIE_BERRY)] = {TYPE_DARK, 90},
    [ITEM_TO_BERRY(ITEM_ZINKIE_BERRY)] = {TYPE_STEEL, 90},
    [ITEM_TO_BERRY(ITEM_CARBO_BERRY)] = {TYPE_FIRE, 100},
