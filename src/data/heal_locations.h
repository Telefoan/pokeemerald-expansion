static const struct HealLocation sHealLocations[] =
{
    ...
    [HEAL_LOCATION_BEACH_VILLAGE_1 - 1] = {MAP_GROUP(BEACH_VILLAGE), MAP_NUM(BEACH_VILLAGE), 12, 13},
    [HEAL_LOCATION_BEACHTOWNV2 - 1] = {MAP_GROUP(BEACHTOWNV2), MAP_NUM(BEACHTOWNV2), 10, 10},
    [HEAL_LOCATION_VILLAGE_NW - 1] = {MAP_GROUP(VILLAGE_NW), MAP_NUM(VILLAGE_NW), 15, 15},
    [HEAL_LOCATION_VILLAGE_NC - 1] = {MAP_GROUP(VILLAGE_NC), MAP_NUM(VILLAGE_NC), 0, 0},
    [HEAL_LOCATION_VILLAGE_BEACH - 1] = {MAP_GROUP(VILLAGE_BEACH), MAP_NUM(VILLAGE_BEACH), 25, 8},
    [HEAL_LOCATION_VILLAGE_S - 1] = {MAP_GROUP(VILLAGE_S), MAP_NUM(VILLAGE_S), 3, 5},
    [HEAL_LOCATION_BEACH_VILLAGE_2 - 1] = {MAP_GROUP(BEACH_VILLAGE), MAP_NUM(BEACH_VILLAGE), 26, 22},
};
