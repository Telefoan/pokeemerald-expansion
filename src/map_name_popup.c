...
static const u8 sRegionMapSectionId_To_PopUpThemeIdMapping[] =
{
    ...
    [MAPSEC_BEACH_VILLAGE] = MAPPOPUP_THEME_WOOD,
    [MAPSEC_FOREST_DUNGEON] = MAPPOPUP_THEME_WOOD
};
...
static const u8 sRegionMapSectionId_To_PopUpThemeIdMapping_BW[] =
{
    ...
    [MAPSEC_BEACH_VILLAGE] = MAPPOPUP_THEME_BW_DEFAULT,
    [MAPSEC_FOREST_DUNGEON] = MAPPOPUP_THEME_BW_DEFAULT,
};
